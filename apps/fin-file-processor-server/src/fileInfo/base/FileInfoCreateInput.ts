...
@InputType()
class FileInfoCreateInput {
  @ApiProperty({
    required: false,
    type: () => CryptoInfoCreateNestedManyWithoutFileInfosInput,
  })
  @ValidateNested()
  @Type(() => CryptoInfoCreateNestedManyWithoutFileInfosInput)
  @IsOptional()
  @Field(() => CryptoInfoCreateNestedManyWithoutFileInfosInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => FileContentCreateNestedManyWithoutFileInfosInput,
  })
  @ValidateNested()
  @Type(() => FileContentCreateNestedManyWithoutFileInfosInput)
  @IsOptional()
  @Field(() => FileContentCreateNestedManyWithoutFileInfosInput, {
    nullable: true,
  })
...
export { FileInfoCreateInput as FileInfoCreateInput };
